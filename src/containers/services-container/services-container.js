    ...
    <div className="services__content">
      <div className="service">
        ...
        <div className="service__content">
          Creating easy to use web apps or sites, designed to work on any
          screen, that give the user a wonderful experience.
        </div>
      </div>
      <div className="service">
        <img
        ...
        <div className="service__content">
          Providing cloud hosting and support for your site so you can worry
          about other things.
        </div>
      </div>
      <div className="service">
